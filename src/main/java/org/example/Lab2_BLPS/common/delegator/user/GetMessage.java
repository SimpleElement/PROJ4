...
import org.example.Lab2_BLPS.service.camunda.DelegateAuthCheckService;
...
public class GetMessage implements JavaDelegate {
    ...
    public void execute(DelegateExecution execution) {
        ...
        execution.setVariable("message",
                Arrays.toString(mailService.getMessagesByUsername(
                        username,
                        pageNumber,
                        pageSize
                ).stream().toArray(MessageEntity[]::new))
        );
